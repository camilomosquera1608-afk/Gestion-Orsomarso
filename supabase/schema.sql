...
create table if not exists public.players (
  ...
  competitive_role text,
  date_joined date,
  load_tolerance text,
  max_velocity_reference numeric,
  baseline_wellness numeric,
  baseline_rpe numeric,
  target_weekly_load numeric,
  target_weekly_hsr numeric,
  target_weekly_sprint_distance numeric,
  target_minutes_7d numeric,
  max_training_percent numeric,
  max_competition_minutes numeric,
...
create table if not exists public.competition_players (
  ...
  crosses_defended integer default 0,
  footwork_actions integer default 0,
