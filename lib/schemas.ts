...
export const TrainingSessionTypeSchema = z.enum(['MD+1', 'MD+2', 'MD-5', 'MD-4', 'MD-3', 'MD-2', 'MD-1', 'MD', 'REC_ACTIVA', 'REC_PASIVA', 'CDE_F_OPT_JUGADORES', 'CDE_F_OPT_EQUIPO', 'CDE_F_OPT_CONDICIONAL', 'CDE_F_OPT_JUGADOR']);
