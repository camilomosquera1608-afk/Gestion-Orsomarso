...
export type PlatformRole = 'admin' | 'category_admin' | 'director' | 'scout' | 'entrenador' | 'preparador' | 'medico' | 'analista' | 'valorador' | 'solo_lectura';
...
export const normalizePlatformRole = (role?: string | null): PlatformRole => {
  ...
  if (['secretaria_tecnica', 'secretaria', 'secretario_tecnico', 'secretaria_deportiva'].includes(value)) return 'scout';
