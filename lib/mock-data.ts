...
export const initialData: AppData = {
  trainingSessionSummaries: [
    { id: 'ts1', date: '2026-04-23', category: 'Sub20', microcycleId: 'mc-14', sessionNumber: 1, sessionType: 'cdEf', objective: 'Ejecución de tareas tácticas y control de carga', observation: 'Buena respuesta general del grupo.' },
    { id: 'ts2', date: '2026-04-22', category: 'Sub20', microcycleId: 'mc-14', sessionNumber: 2, sessionType: 'cdeF', objective: 'Desarrollo de condición física específica', observation: 'Dos jugadores quedaron por debajo del rango previsto.' }
  ],
  microcycles: [
