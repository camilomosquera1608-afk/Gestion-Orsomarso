...
export const initialData: AppData = {
  ...
  players: [
    { id: 'p1', name: 'Juan Camilo Ruiz', age: 26, position: 'Portero', height: 189, weight: 84, status: 'Disponible', photo: playerPhotos[0] },
    { id: 'p2', name: 'Brayan Mosquera', age: 23, position: 'Defensa central', height: 184, weight: 79, status: 'Disponible', photo: playerPhotos[1] },
    { id: 'p3', name: 'Kevin Salazar', age: 21, position: 'Lateral', height: 176, weight: 72, status: 'Molestia', photo: playerPhotos[2] },
    { id: 'p4', name: 'Andrés Cuesta', age: 24, position: 'Mediocampista', height: 178, weight: 74, status: 'Disponible', photo: playerPhotos[3] },
    { id: 'p5', name: 'Johan Murillo', age: 27, position: 'Extremo', height: 175, weight: 70, status: 'Readaptación', photo: playerPhotos[4] },
    { id: 'p6', name: 'Santiago Arboleda', age: 25, position: 'Delantero', height: 181, weight: 77, status: 'Lesionado', photo: playerPhotos[0] }
  ],
  wellness: [
